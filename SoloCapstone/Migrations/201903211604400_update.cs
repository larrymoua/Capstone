namespace SoloCapstone.Migrations
{
    ...
    public partial class update : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        OrderConfirmationNumber = c.String(),
                ...
                c => new
                    {
                        ...
                        PartName = c.Int(nullable: false),
                        AWG = c.Int(nullable: false),
                        Impedance = c.String(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CoaxialCables", "OrderId", "dbo.Orders");
            DropForeignKey("dbo.ProductionManagers", "ApplicationUserId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.CoaxialCables", new[] { "OrderId" });
            DropIndex("dbo.ProductionManagers", new[] { "ApplicationUserId" });
            ...
            DropTable("dbo.CoaxialCables");
            DropTable("dbo.ProductionManagers");
